            ...
            <div class="card-body">
                    ...
                    <div class="form-group col-md-6">
                       ...
                       @can('change_email')
                           <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                               ...
                               {!! Form::email('email', $admin->email, ['class' => 'form-control',  'placeholder' => 'eg: foo@bar.com', 'autocomplete'=>'nope']) !!}
                               <small class="text-danger">{{ $errors->first('email') }}</small>
                           </div>
                       @endcan
                       ...
                       <div class="form-group{{ $errors->has('contact_number') ? ' has-error' : '' }}">
                           ...
                           {!! Form::text('contact_number', $admin->mobile, ['class' => 'form-control', 'placeholder' => 'Contact Number']) !!}
                       ...
                       <div class="form-group" style="margin-top: 40px; margin-bottom: 0;">
                        ...
                        {!! Form::submit('Update User', ['class' => 'btn btn-soft-secondary waves-effect waves-light']) !!}
                ...
                <div class="form-group col-md-6">
                 ...
                 <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                     ...
                     {!! Form::select('status', [1=>'Active', 0=>'Inactive'], $admin->status, ['id'=>'user_status','class' => 'form-control', 'placeholder' => 'User Staus']) !!}
                 ...
                 <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('date_of_birth', $admin->date_of_birth, ['class' => 'form-control', 'data-date-format'=>'dd M, yyyy', 'data-provide'=>'datepicker',  'placeholder'=>'Date Of Birth', 'data-provider'=>'flatpickr', 'data-date-format'=>'d M, Y']) !!}
                        <div class="input-group-append">
                            <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                        </div>
                    </div>
                ...
                <div class="form-group{{ $errors->has('role') ? ' has-error' : '' }}">
                    ...
                    {!! Form::select('role', App\Models\Role::whereNotIn('id',[1])->pluck('name','id'), $admin->role_id, ['id' => 'role', 'class' => 'form-control', 'placeholder'=>'Select Role']) !!}
                ...
                <div class="form-group {{ $errors->has('avatar') ? ' has-error' : '' }}">
                    ...
                    {!! Form::file('avatar', ['class'=>'dropify', 'data-default-file'=>asset($admin->avatar)]) !!}
